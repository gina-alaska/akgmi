Ext.data.JsonP.Ext_draw_CompositeSprite({
  ...
  "members": {
    ...
    "method": [
      ...
      {
        "doc": "<p>Adds an item to the collection. Fires the <a href=\"#/api/Ext.draw.CompositeSprite-event-add\" rel=\"Ext.draw.CompositeSprite-event-add\" class=\"docClass\">add</a> event when complete.</p>\n",
