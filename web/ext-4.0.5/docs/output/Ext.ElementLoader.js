Ext.data.JsonP.Ext_ElementLoader({
  ...
  "doc": "<p>A class used to load remote content to an Element. Sample usage:</p>\n\n<pre><code>Ext.get('el').load({\n    url: 'myPage.php',\n    scripts: true,\n    params: {\n        id: 1\n    }\n});\n</code></pre>\n\n<p>In general this class will not be instanced directly, rather the <a href=\"#/api/Ext.Element-event-load\" rel=\"Ext.Element-event-load\" class=\"docClass\">Ext.Element.load</a> method\nwill be used.</p>\n",
  "extends": "Ext.Base",
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "Boolean/Object",
        "doc": "<p>True to have the loader make a request as soon as it is created. Defaults to false.\nThis argument can also be a set of options that will be passed to <a href=\"#/api/Ext.ElementLoader-event-load\" rel=\"Ext.ElementLoader-event-load\" class=\"docClass\">load</a> is called.</p>\n",
    ...
    "method": [
      ...
      },
      {
        ...
        "params": [
          ...
          {
            "doc": "<p>(optional) The options to pass to the load method. See <a href=\"#/api/Ext.ElementLoader-event-load\" rel=\"Ext.ElementLoader-event-load\" class=\"docClass\">load</a></p>\n",
            "type": "Object",
            "optional": true,
            "name": "options"
          }
