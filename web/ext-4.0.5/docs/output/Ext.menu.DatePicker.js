Ext.data.JsonP.Ext_menu_DatePicker({
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "String",
        "doc": "<p>The action to take when the close header tool is clicked:\n<div class=\"mdetail-params\"><ul>\n<li><b><code>'<a href=\"#/api/Ext.menu.DatePicker-event-destroy\" rel=\"Ext.menu.DatePicker-event-destroy\" class=\"docClass\">destroy</a>'</code></b> : <b>Default</b><div class=\"sub-desc\">\n<a href=\"#/api/Ext.menu.DatePicker-event-destroy\" rel=\"Ext.menu.DatePicker-event-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>\nit and all descendant Components. The window will <b>not</b> be available to be\nredisplayed via the <a href=\"#/api/Ext.menu.DatePicker-event-show\" rel=\"Ext.menu.DatePicker-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n<li><b><code>'<a href=\"#/api/Ext.menu.DatePicker-event-hide\" rel=\"Ext.menu.DatePicker-event-hide\" class=\"docClass\">hide</a>'</code></b> : <div class=\"sub-desc\">\n<a href=\"#/api/Ext.menu.DatePicker-event-hide\" rel=\"Ext.menu.DatePicker-event-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets.\nThe window will be available to be redisplayed via the <a href=\"#/api/Ext.menu.DatePicker-event-show\" rel=\"Ext.menu.DatePicker-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n</ul></div>\n<p><b>Note:</b> This behavior has changed! setting *does* affect the <a href=\"#/api/Ext.menu.DatePicker-method-close\" rel=\"Ext.menu.DatePicker-method-close\" class=\"docClass\">close</a> method\nwhich will invoke the approriate closeAction.\n\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.menu.DatePicker-cfg-collapsible\" rel=\"Ext.menu.DatePicker-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p><tt>true</tt> to allow clicking a collapsed Panel&#39;s <a href=\"#/api/Ext.menu.DatePicker-cfg-placeholder\" rel=\"Ext.menu.DatePicker-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated\nabove the layout, <tt>false</tt> to force the user to fully expand a collapsed region by\nclicking the expand button to see it again (defaults to <tt>true</tt>).</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.menu.DatePicker-cfg-collapsible\" rel=\"Ext.menu.DatePicker-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>,\n<code>false</code> to display it (defaults to <code>false</code>).</p>\n",
      ...
      },
      {
        ...
        "protected": false,
        "deprecated": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/menu/DatePicker.js",
        "private": false,
        "tagname": "cfg",
        "name": "hideOnClick",
      ...
      {
        "type": "String",
        "doc": "<p>An id to assign to the underlying date picker. Defaults to <tt>null</tt>.</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.menu.DatePicker-cfg-collapsible\" rel=\"Ext.menu.DatePicker-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>)\nby clicking anywhere in the header bar, <code>false</code>) to allow it only by clicking to tool button\n(defaults to <code>false</code>)).</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.menu.DatePicker-method-toFront\" rel=\"Ext.menu.DatePicker-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.menu.DatePicker-event-show\" rel=\"Ext.menu.DatePicker-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
      ...
      },
      {
        ...
        "doc": "<p>An array of <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Ext.panel.Tool</a> configs/instances to be added to the header tool area. The tools are stored as child\ncomponents of the header container. They can be accessed using <a href=\"#/api/Ext.menu.DatePicker-method-down\" rel=\"Ext.menu.DatePicker-method-down\" class=\"docClass\">down</a> and {#query}, as well as the other\ncomponent methods. The toggle tool is automatically created if <a href=\"#/api/Ext.menu.DatePicker-cfg-collapsible\" rel=\"Ext.menu.DatePicker-cfg-collapsible\" class=\"docClass\">collapsible</a> is set to true.</p>\n\n<p>Note that, apart from the toggle tool which is provided when a panel is collapsible, these\ntools only provide the visual button. Any required functionality must be provided by adding\nhandlers that implement the necessary behavior.</p>\n\n\n<p>Example usage:</p>\n\n\n<pre><code>tools:[{\n    type:'refresh',\n    tooltip: 'Refresh form Data',\n    // hidden:true,\n    handler: function(event, toolEl, panel){\n        // refresh logic\n    }\n},\n{\n    type:'help',\n    tooltip: 'Get Help',\n    handler: function(event, toolEl, panel){\n        // show help here\n    }\n}]\n</code></pre>\n\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>s\nthe Panel object and all its descendant Components. The <a href=\"#/api/Ext.menu.DatePicker-event-beforeclose\" rel=\"Ext.menu.DatePicker-event-beforeclose\" class=\"docClass\">beforeclose</a>\nevent is fired before the close happens and will cancel the close action if it returns false.<p>\n<p><b>Note:</b> This method is not affected by the <a href=\"#/api/Ext.menu.DatePicker-cfg-closeAction\" rel=\"Ext.menu.DatePicker-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which\nonly affects the action triggered when clicking the <a href=\"#/api/Ext.menu.DatePicker-cfg-closable\" rel=\"Ext.menu.DatePicker-cfg-closable\" class=\"docClass\">'close' tool in the header</a>.\nTo hide the Panel without destroying it, call <a href=\"#/api/Ext.menu.DatePicker-event-hide\" rel=\"Ext.menu.DatePicker-event-hide\" class=\"docClass\">hide</a>.</p>\n\n",
      ...
      {
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.menu.DatePicker-event-beforecollapse\" rel=\"Ext.menu.DatePicker-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
      ...
      {
        "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.menu.DatePicker-event-beforeexpand\" rel=\"Ext.menu.DatePicker-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
      ...
      {
        "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.menu.DatePicker-event-beforeadd\" rel=\"Ext.menu.DatePicker-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.menu.DatePicker-event-add\" rel=\"Ext.menu.DatePicker-event-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
      ...
      {
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.menu.DatePicker-event-expand\" rel=\"Ext.menu.DatePicker-event-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.menu.DatePicker-event-collapse\" rel=\"Ext.menu.DatePicker-event-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.menu.DatePicker-event-destroy\" rel=\"Ext.menu.DatePicker-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.menu.DatePicker-event-destroy\" rel=\"Ext.menu.DatePicker-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.menu.DatePicker-event-hide\" rel=\"Ext.menu.DatePicker-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.menu.DatePicker-event-show\" rel=\"Ext.menu.DatePicker-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.menu.DatePicker-event-destroy\" rel=\"Ext.menu.DatePicker-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.menu.DatePicker-event-hide\" rel=\"Ext.menu.DatePicker-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.menu.DatePicker-event-show\" rel=\"Ext.menu.DatePicker-event-show\" class=\"docClass\">show</a> method.</p>\n",
    ...
    "property": [
      {
        ...
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.menu.DatePicker-property-draggable\" rel=\"Ext.menu.DatePicker-property-draggable\" class=\"docClass\">draggable</a>, this property will contain\nan instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a>\nin order to supply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.menu.DatePicker-property-draggable\" rel=\"Ext.menu.DatePicker-property-draggable\" class=\"docClass\">draggable</a>.</p>\n",
