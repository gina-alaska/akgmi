Ext.data.JsonP.Ext_tab_Tab({
  ...
  "members": {
    "cfg": [
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/tab/Tab.js",
        "private": false,
        "tagname": "cfg",
        "name": "activeCls",
        "owner": "Ext.tab.Tab",
      ...
      {
        "type": "Boolean",
        "doc": "<p>False to not allow a pressed Button to be depressed (defaults to undefined). Only valid when <a href=\"#/api/Ext.tab.Tab-cfg-enableToggle\" rel=\"Ext.tab.Tab-cfg-enableToggle\" class=\"docClass\">enableToggle</a> is true.</p>\n",
      ...
      {
        "type": "String",
        "doc": "<p>(Optional) The side of the Button box to render the arrow if the button has an associated <a href=\"#/api/Ext.tab.Tab-property-menu\" rel=\"Ext.tab.Tab-property-menu\" class=\"docClass\">menu</a>.\nTwo values are allowed:</p>\n\n\n<ul class=\"mdetail-params\">\n<li>'right'<div class=\"sub-desc\"></div></li>\n<li>'bottom'<div class=\"sub-desc\"></div></li>\n</ul>\n\n\n<p>Defaults to <b><tt>'right'</tt></b>.</p>\n\n",
      ...
      {
        "type": "Object",
        "doc": "<p>An object literal of parameters to pass to the url when the <a href=\"#/api/Ext.tab.Tab-cfg-href\" rel=\"Ext.tab.Tab-cfg-href\" class=\"docClass\">href</a> property is specified.\nAny params override <a href=\"#/api/Ext.tab.Tab-cfg-baseParams\" rel=\"Ext.tab.Tab-cfg-baseParams\" class=\"docClass\">baseParams</a>. New params can be set using the <a href=\"#/api/Ext.tab.Tab-method-setParams\" rel=\"Ext.tab.Tab-method-setParams\" class=\"docClass\">setParams</a> method.</p>\n",
      ...
      {
        "type": "Object",
        "doc": "<p>The scope (<tt><b>this</b></tt> reference) in which the\n<code><a href=\"#/api/Ext.tab.Tab-cfg-handler\" rel=\"Ext.tab.Tab-cfg-handler\" class=\"docClass\">handler</a></code> and <code><a href=\"#/api/Ext.tab.Tab-cfg-toggleHandler\" rel=\"Ext.tab.Tab-cfg-toggleHandler\" class=\"docClass\">toggleHandler</a></code> is\nexecuted. Defaults to this Button.</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.tab.Tab-method-toFront\" rel=\"Ext.tab.Tab-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.tab.Tab-event-show\" rel=\"Ext.tab.Tab-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
      ...
      {
        "type": "Function",
        "doc": "<p>Function called when a Button with <a href=\"#/api/Ext.tab.Tab-cfg-enableToggle\" rel=\"Ext.tab.Tab-cfg-enableToggle\" class=\"docClass\">enableToggle</a> set to true is clicked. Two arguments are passed:<ul class=\"mdetail-params\">\n<li><b>button</b> : <a href=\"#/api/Ext.button.Button\" rel=\"Ext.button.Button\" class=\"docClass\">Ext.button.Button</a><div class=\"sub-desc\">this Button object</div></li>\n<li><b>state</b> : Boolean<div class=\"sub-desc\">The next state of the Button, true means pressed.</div></li>\n</ul></p>\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Sets the background image (inline style) of the button.  This method also changes\nthe value of the <a href=\"#/api/Ext.tab.Tab-cfg-icon\" rel=\"Ext.tab.Tab-cfg-icon\" class=\"docClass\">icon</a> config internally.</p>\n",
      ...
      {
        "doc": "<p>Sets the CSS class that provides a background image to use as the button's icon.  This method also changes\nthe value of the <a href=\"#/api/Ext.tab.Tab-cfg-iconCls\" rel=\"Ext.tab.Tab-cfg-iconCls\" class=\"docClass\">iconCls</a> config internally.</p>\n",
      ...
      {
        "doc": "<p><b>Only valid if the Button was originally configured with a <a href=\"#/api/Ext.tab.Tab-cfg-href\" rel=\"Ext.tab.Tab-cfg-href\" class=\"docClass\">href</a></b></p>\n\n\n<p>Sets the href of the link dynamically according to the params passed, and any <a href=\"#/api/Ext.tab.Tab-cfg-baseParams\" rel=\"Ext.tab.Tab-cfg-baseParams\" class=\"docClass\">baseParams</a> configured.</p>\n\n",
        ...
        "deprecated": null,
        "shortDoc": "Only valid if the Button was originally configured with a href\n\n\nSets the href of the link dynamically according to t...",
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "tagname": "method",
        "name": "setParams",
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.tab.Tab-event-destroy\" rel=\"Ext.tab.Tab-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.tab.Tab-event-destroy\" rel=\"Ext.tab.Tab-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.tab.Tab-event-hide\" rel=\"Ext.tab.Tab-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.tab.Tab-event-show\" rel=\"Ext.tab.Tab-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.tab.Tab-event-destroy\" rel=\"Ext.tab.Tab-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.tab.Tab-event-hide\" rel=\"Ext.tab.Tab-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.tab.Tab-event-show\" rel=\"Ext.tab.Tab-event-show\" class=\"docClass\">show</a> method.</p>\n",
    ...
    "property": [
      ...
      {
        "type": "Ext.menu.Menu",
        "doc": "<p>The <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a> object associated with this Button when configured with the <a href=\"#/api/Ext.tab.Tab-property-menu\" rel=\"Ext.tab.Tab-property-menu\" class=\"docClass\">menu</a> config option.</p>\n",
