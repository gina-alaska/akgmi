Ext.data.JsonP.Ext_ComponentLoader({
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "Boolean/Object",
        "doc": "<p>True to have the loader make a request as soon as it is created. Defaults to false.\nThis argument can also be a set of options that will be passed to <a href=\"#/api/Ext.ComponentLoader-event-load\" rel=\"Ext.ComponentLoader-event-load\" class=\"docClass\">load</a> is called.</p>\n",
    ...
    "method": [
      ...
      },
      {
        ...
        "params": [
          ...
          {
            "doc": "<p>(optional) The options to pass to the load method. See <a href=\"#/api/Ext.ComponentLoader-event-load\" rel=\"Ext.ComponentLoader-event-load\" class=\"docClass\">load</a></p>\n",
            "type": "Object",
            "optional": true,
            "name": "options"
          }
