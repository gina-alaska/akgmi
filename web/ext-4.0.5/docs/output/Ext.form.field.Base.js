Ext.data.JsonP.Ext_form_field_Base({
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "String",
        "doc": "<p>Optional CSS style(s) to be applied to the <a href=\"#/api/Ext.form.field.Base-property-inputEl\" rel=\"Ext.form.field.Base-property-inputEl\" class=\"docClass\">field input element</a>.\nShould be a valid argument to <a href=\"#/api/Ext.Element-method-applyStyles\" rel=\"Ext.Element-method-applyStyles\" class=\"docClass\">Ext.Element.applyStyles</a>. Defaults to undefined. See also the\n<a href=\"#/api/Ext.form.field.Base-method-setFieldStyle\" rel=\"Ext.form.field.Base-method-setFieldStyle\" class=\"docClass\">setFieldStyle</a> method for changing the style after initialization.</p>\n",
      ...
      {
        "type": "String",
        "doc": "<p>The name of the field (defaults to undefined). This is used as the parameter\nname when including the field value in a <a href=\"#/api/Ext.form.Basic-method-submit\" rel=\"Ext.form.Basic-method-submit\" class=\"docClass\">form submit()</a>. If no name is\nconfigured, it falls back to the <a href=\"#/api/Ext.form.field.Base-cfg-inputId\" rel=\"Ext.form.field.Base-cfg-inputId\" class=\"docClass\">inputId</a>. To prevent the field from being included in the\nform submit, set <a href=\"#/api/Ext.form.field.Base-cfg-submitValue\" rel=\"Ext.form.field.Base-cfg-submitValue\" class=\"docClass\">submitValue</a> to <tt>false</tt>.</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.form.field.Base-method-toFront\" rel=\"Ext.form.field.Base-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.form.field.Base-event-show\" rel=\"Ext.form.field.Base-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Checks the <a href=\"#/api/Ext.form.field.Base-method-isDirty\" rel=\"Ext.form.field.Base-method-isDirty\" class=\"docClass\">isDirty</a> state of the field and if it has changed since the last time\nit was checked, fires the <a href=\"#/api/Ext.form.field.Base-event-dirtychange\" rel=\"Ext.form.field.Base-event-dirtychange\" class=\"docClass\">dirtychange</a> event.</p>\n",
      ...
      {
        "doc": "<p>Only relevant if the instance's <a href=\"#/api/Ext.form.field.Base-method-isFileUpload\" rel=\"Ext.form.field.Base-method-isFileUpload\" class=\"docClass\">isFileUpload</a> method returns true. Returns a reference\nto the file input DOM element holding the user's selected file. The input will be appended into\nthe submission form and will not be returned, so this method should also create a replacement.</p>\n",
      ...
      {
        "doc": "<p>Returns the input id for this field. If none was specified via the <a href=\"#/api/Ext.form.field.Base-cfg-inputId\" rel=\"Ext.form.field.Base-cfg-inputId\" class=\"docClass\">inputId</a> config,\nthen an id will be automatically generated.</p>\n",
      ...
      {
        "doc": "<p>Returns the raw value of the field, without performing any normalization, conversion, or validation.\nTo get a normalized and converted value see <a href=\"#/api/Ext.form.field.Base-method-getValue\" rel=\"Ext.form.field.Base-method-getValue\" class=\"docClass\">getValue</a>.</p>\n",
      ...
      {
        "doc": "<p>Returns the value that would be included in a standard form submit for this field. This will be combined\nwith the field's name to form a <tt>name=value</tt> pair in the <a href=\"#/api/Ext.form.field.Base-method-getSubmitData\" rel=\"Ext.form.field.Base-method-getSubmitData\" class=\"docClass\">submitted parameters</a>.\nIf an empty string is returned then just the <tt>name=</tt> will be submitted; if <tt>null</tt> is returned\nthen nothing will be submitted.</p>\n\n\n<p>Note that the value returned will have been <a href=\"#/api/Ext.form.field.Base-method-processRawValue\" rel=\"Ext.form.field.Base-method-processRawValue\" class=\"docClass\">processed</a> but may or may not have\nbeen successfully <a href=\"#/api/Ext.form.field.Base-method-validate\" rel=\"Ext.form.field.Base-method-validate\" class=\"docClass\">validated</a>.</p>\n\n",
      ...
      {
        "doc": "<p>Returns whether two field <a href=\"#/api/Ext.form.field.Base-method-getValue\" rel=\"Ext.form.field.Base-method-getValue\" class=\"docClass\">values</a> are logically equal. Field implementations may override\nthis to provide custom comparison logic appropriate for the particular field's data type.</p>\n",
      ...
      {
        "doc": "<p>Returns whether or not the field value is currently valid by\n<a href=\"#/api/Ext.form.field.Base-method-getErrors\" rel=\"Ext.form.field.Base-method-getErrors\" class=\"docClass\">validating</a> the <a href=\"#/api/Ext.form.field.Base-method-processRawValue\" rel=\"Ext.form.field.Base-method-processRawValue\" class=\"docClass\">processed raw value</a>\nof the field. <b>Note</b>: <a href=\"#/api/Ext.form.field.Base-cfg-disabled\" rel=\"Ext.form.field.Base-cfg-disabled\" class=\"docClass\">disabled</a> fields are always treated as valid.</p>\n",
      ...
      {
        "doc": "<p>Performs any necessary manipulation of a raw field value to prepare it for <a href=\"#/api/Ext.form.field.Base-method-rawToValue\" rel=\"Ext.form.field.Base-method-rawToValue\" class=\"docClass\">conversion</a>\nand/or <a href=\"#/api/Ext.form.field.Base-method-validate\" rel=\"Ext.form.field.Base-method-validate\" class=\"docClass\">validation</a>, for instance stripping out ignored characters. In the base implementation\nit does nothing; individual subclasses may override this as needed.</p>\n",
      ...
      {
        "doc": "<p>Returns whether or not the field value is currently valid by <a href=\"#/api/Ext.form.field.Base-method-getErrors\" rel=\"Ext.form.field.Base-method-getErrors\" class=\"docClass\">validating</a> the\nfield's current value, and fires the <a href=\"#/api/Ext.form.field.Base-event-validitychange\" rel=\"Ext.form.field.Base-event-validitychange\" class=\"docClass\">validitychange</a> event if the field's validity has\nchanged since the last validation. <b>Note</b>: <a href=\"#/api/Ext.form.field.Base-cfg-disabled\" rel=\"Ext.form.field.Base-cfg-disabled\" class=\"docClass\">disabled</a> fields are always treated as valid.</p>\n\n\n<p>Custom implementations of this method are allowed to have side-effects such as triggering error\nmessage display. To validate without side-effects, use <a href=\"#/api/Ext.form.field.Base-method-isValid\" rel=\"Ext.form.field.Base-method-isValid\" class=\"docClass\">isValid</a>.</p>\n\n",
      ...
      {
        "doc": "<p>Uses <a href=\"#/api/Ext.form.field.Base-method-getErrors\" rel=\"Ext.form.field.Base-method-getErrors\" class=\"docClass\">getErrors</a> to build an array of validation errors. If any errors are found, they are passed\nto <a href=\"#/api/Ext.form.field.Base-method-markInvalid\" rel=\"Ext.form.field.Base-method-markInvalid\" class=\"docClass\">markInvalid</a> and false is returned, otherwise true is returned.</p>\n\n\n<p>Previously, subclasses were invited to provide an implementation of this to process validations - from 3.2\nonwards <a href=\"#/api/Ext.form.field.Base-method-getErrors\" rel=\"Ext.form.field.Base-method-getErrors\" class=\"docClass\">getErrors</a> should be overridden instead.</p>\n\n",
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.form.field.Base-event-destroy\" rel=\"Ext.form.field.Base-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.form.field.Base-event-destroy\" rel=\"Ext.form.field.Base-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.form.field.Base-event-hide\" rel=\"Ext.form.field.Base-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.form.field.Base-event-show\" rel=\"Ext.form.field.Base-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.form.field.Base-event-destroy\" rel=\"Ext.form.field.Base-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.form.field.Base-event-hide\" rel=\"Ext.form.field.Base-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.form.field.Base-event-show\" rel=\"Ext.form.field.Base-event-show\" class=\"docClass\">show</a> method.</p>\n",
