Ext.data.JsonP.Ext_window_Window({
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "Number",
        "doc": "<p>The X position of the left edge of the window on initial showing. Defaults to centering the Window within\nthe width of the Window's container {@link <a href=\"#/api/Ext.Element\" rel=\"Ext.Element\" class=\"docClass\">Ext.Element</a> Element) (The Element that the Window is rendered to).</p>\n",
      ...
      {
        "type": "Number",
        "doc": "<p>The Y position of the top edge of the window on initial showing. Defaults to centering the Window within\nthe height of the Window's container {@link <a href=\"#/api/Ext.Element\" rel=\"Ext.Element\" class=\"docClass\">Ext.Element</a> Element) (The Element that the Window is rendered to).</p>\n",
