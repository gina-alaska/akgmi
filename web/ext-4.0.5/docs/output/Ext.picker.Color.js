Ext.data.JsonP.Ext_picker_Color({
  ...
  "doc": "<p>ColorPicker provides a simple color palette for choosing colors. The picker can be rendered to any container.\nThe available default to a standard 40-color palette; this can be customized with the <a href=\"#/api/Ext.picker.Color-property-colors\" rel=\"Ext.picker.Color-property-colors\" class=\"docClass\">colors</a> config.</p>\n\n\n<p>Typically you will need to implement a handler function to be notified when the user chooses a color from the\npicker; you can register the handler using the <a href=\"#/api/Ext.picker.Color-event-select\" rel=\"Ext.picker.Color-event-select\" class=\"docClass\">select</a> event, or by implementing the <a href=\"#/api/Ext.picker.Color-cfg-handler\" rel=\"Ext.picker.Color-cfg-handler\" class=\"docClass\">handler</a>\nmethod.</p>\n\n\n<p>Here's an example of typical usage:</p>\n\n\n<pre><code>var cp = new Ext.picker.Color({\n    value: '993300',  // initial selected color\n    renderTo: 'my-div'\n});\n\ncp.on('select', function(picker, selColor){\n    // do something with selColor\n});\n</code></pre>\n\n\n<p><p><img src=\"doc-resources/Ext.picker.Color/Ext.picker.Color.png\" alt=\"Ext.picker.Color component\"></p></p>\n",
  ...
  "members": {
    "cfg": [
      {
        "type": "Boolean",
        "doc": "<p>If set to true then reselecting a color that is already selected fires the <a href=\"#/api/Ext.picker.Color-event-select\" rel=\"Ext.picker.Color-event-select\" class=\"docClass\">select</a> event</p>\n",
        ...
        "protected": false,
        "deprecated": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/picker/Color.js",
        "private": false,
        "tagname": "cfg",
        "name": "allowReselect",
      ...
      {
        "type": "Function",
        "doc": "<p>A function that will handle the select event of this picker.\nThe handler is passed the following parameters:<div class=\"mdetail-params\"><ul>\n<li><code>picker</code> : ColorPicker<div class=\"sub-desc\">The <a href=\"#/api/Ext.picker.Color\" rel=\"Ext.picker.Color\" class=\"docClass\">picker</a>.</div></li>\n<li><code>color</code> : String<div class=\"sub-desc\">The 6-digit color hex code (without the # symbol).</div></li>\n</ul></div></p>\n",
      ...
      {
        "type": "Object",
        "doc": "<p>The scope (<tt><b>this</b></tt> reference) in which the <code><a href=\"#/api/Ext.picker.Color-cfg-handler\" rel=\"Ext.picker.Color-cfg-handler\" class=\"docClass\">handler</a></code>\nfunction will be called.  Defaults to this ColorPicker instance.</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.picker.Color-method-toFront\" rel=\"Ext.picker.Color-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.picker.Color-event-show\" rel=\"Ext.picker.Color-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
      ...
      {
        "type": "String",
        "doc": "<p>The initial color to highlight (should be a valid 6-digit color hex code without the # symbol).  Note that\nthe hex codes are case-sensitive.</p>\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Selects the specified color in the picker (fires the <a href=\"#/api/Ext.picker.Color-event-select\" rel=\"Ext.picker.Color-event-select\" class=\"docClass\">select</a> event)</p>\n",
        ...
        "params": [
          ...
          {
            "doc": "<p>(optional) True to stop the select event from firing. Defaults to <tt>false</tt>.</p>\n",
            "type": "Boolean",
            "optional": true,
            "name": "suppressEvent"
          }
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.picker.Color-event-destroy\" rel=\"Ext.picker.Color-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.picker.Color-event-destroy\" rel=\"Ext.picker.Color-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.picker.Color-event-hide\" rel=\"Ext.picker.Color-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.picker.Color-event-show\" rel=\"Ext.picker.Color-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.picker.Color-event-destroy\" rel=\"Ext.picker.Color-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.picker.Color-event-hide\" rel=\"Ext.picker.Color-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.picker.Color-event-show\" rel=\"Ext.picker.Color-event-show\" class=\"docClass\">show</a> method.</p>\n",
