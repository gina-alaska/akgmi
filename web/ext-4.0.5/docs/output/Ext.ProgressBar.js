Ext.data.JsonP.Ext_ProgressBar({
  ...
  "members": {
    "cfg": [
      {
        ...
        "protected": false,
        "deprecated": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/ProgressBar.js",
        "private": false,
        "tagname": "cfg",
        "name": "animate",
      ...
      {
        "type": "String/HTMLElement/Ext.Element",
        "doc": "<p>The element to render the progress text to (defaults to the progress\nbar's internal text element)</p>\n",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.ProgressBar-method-toFront\" rel=\"Ext.ProgressBar-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.ProgressBar-event-show\" rel=\"Ext.ProgressBar-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Resets the progress bar value to 0 and text to empty string.  If hide = true, the progress\nbar will also be hidden (using the <a href=\"#/api/Ext.ProgressBar-cfg-hideMode\" rel=\"Ext.ProgressBar-cfg-hideMode\" class=\"docClass\">hideMode</a> property internally).</p>\n",
      ...
      {
        "doc": "<p>Updates the progress bar value, and optionally its text.  If the text argument is not specified,\nany existing text value will be unchanged.  To blank out existing text, pass ''.  Note that even\nif the progress bar value exceeds 1, it will never automatically reset -- you are responsible for\ndetermining when the progress is complete and calling <a href=\"#/api/Ext.ProgressBar-method-reset\" rel=\"Ext.ProgressBar-method-reset\" class=\"docClass\">reset</a> to clear and/or hide the control.</p>\n",
        ...
        "params": [
          ...
          {
            "doc": "<p>(optional) Whether to animate the transition of the progress bar. If this value is\nnot specified, the default for the class is used (default to false)</p>\n",
            "type": "Boolean",
            "optional": true,
            "name": "animate"
          }
      ...
      {
        "doc": "<p>Updates the progress bar text.  If specified, textEl will be updated, otherwise the progress\nbar itself will display the updated text.</p>\n",
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.ProgressBar-event-destroy\" rel=\"Ext.ProgressBar-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.ProgressBar-event-destroy\" rel=\"Ext.ProgressBar-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.ProgressBar-event-hide\" rel=\"Ext.ProgressBar-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.ProgressBar-event-show\" rel=\"Ext.ProgressBar-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.ProgressBar-event-destroy\" rel=\"Ext.ProgressBar-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.ProgressBar-event-hide\" rel=\"Ext.ProgressBar-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.ProgressBar-event-show\" rel=\"Ext.ProgressBar-event-show\" class=\"docClass\">show</a> method.</p>\n",
