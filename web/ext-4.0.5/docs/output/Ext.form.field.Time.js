Ext.data.JsonP.Ext_form_field_Time({
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "String",
        "doc": "<p>The <a href=\"#/api/Ext.Element-method-alignTo\" rel=\"Ext.Element-method-alignTo\" class=\"docClass\">alignment position</a> with which to align the picker. Defaults\nto <tt>\"tl-bl?\"</tt></p>\n",
      ...
      {
        "type": "String",
        "doc": "<p>The date format string which will be submitted to the server.\nThe format must be valid according to <a href=\"#/api/Ext.Date-method-parse\" rel=\"Ext.Date-method-parse\" class=\"docClass\">Ext.Date.parse</a> (defaults to <tt><a href=\"#/api/Ext.form.field.Time-cfg-format\" rel=\"Ext.form.field.Time-cfg-format\" class=\"docClass\">format</a></tt>).</p>\n",
