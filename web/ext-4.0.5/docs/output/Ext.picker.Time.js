Ext.data.JsonP.Ext_picker_Time({
  ...
  "doc": "<p>A time picker which provides a list of times from which to choose. This is used by the\n<a href=\"#/api/Ext.form.field.Time\" rel=\"Ext.form.field.Time\" class=\"docClass\">Ext.form.field.Time</a> class to allow browsing and selection of valid times, but could also be used\nwith other components.</p>\n\n\n<p>By default, all times starting at midnight and incrementing every 15 minutes will be presented.\nThis list of available times can be controlled using the <a href=\"#/api/Ext.picker.Time-cfg-minValue\" rel=\"Ext.picker.Time-cfg-minValue\" class=\"docClass\">minValue</a>, <a href=\"#/api/Ext.picker.Time-cfg-maxValue\" rel=\"Ext.picker.Time-cfg-maxValue\" class=\"docClass\">maxValue</a>, and\n<a href=\"#/api/Ext.picker.Time-cfg-increment\" rel=\"Ext.picker.Time-cfg-increment\" class=\"docClass\">increment</a> configuration properties. The format of the times presented in the list can be\ncustomized with the <a href=\"#/api/Ext.picker.Time-cfg-format\" rel=\"Ext.picker.Time-cfg-format\" class=\"docClass\">format</a> config.</p>\n\n\n<p>To handle when the user selects a time from the list, you can subscribe to the <a href=\"#/api/Ext.picker.Time-event-selectionchange\" rel=\"Ext.picker.Time-event-selectionchange\" class=\"docClass\">selectionchange</a>\nevent.</p>\n\n\n<p><p><img src=\"doc-resources/Ext.picker.Time/Ext.picker.Time.png\" alt=\"Ext.picker.Time component\"></p></p>\n\n<h2>Code</h2>\n\n<pre><code> new Ext.create('Ext.picker.Time', {\n    width: 60,\n    minValue: Ext.Date.parse('04:30:00 AM', 'h:i:s A'),\n    maxValue: Ext.Date.parse('08:00:00 AM', 'h:i:s A'),\n    renderTo: Ext.getBody()\n});\n</code></pre>\n",
  "extends": "Ext.view.BoundList",
  "href": "Time.html#Ext-picker-Time",
  "allMixins": [
    "Ext.util.Floating",
    "Ext.util.Observable",
    "Ext.util.Animate",
  ...
  "members": {
    "cfg": [
      ...
      {
        "type": "String",
        "doc": "<p>The default time format string which can be overriden for localization support. The format must be\nvalid according to <a href=\"#/api/Ext.Date-method-parse\" rel=\"Ext.Date-method-parse\" class=\"docClass\">Ext.Date.parse</a> (defaults to 'g:i A', e.g., '3:15 PM'). For 24-hour time\nformat try 'H:i' instead.</p>\n",
        "href": "Time.html#Ext-picker-Time-cfg-format",
        "linenr": 48,
        "html_filename": "Time.html",
        "alias": null,
        "protected": false,
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/picker/Time.js",
        "private": false,
        "tagname": "cfg",
        "name": "format",
      ...
      },
      {
        ...
        "href": "Time.html#Ext-picker-Time-cfg-increment",
        "linenr": 42,
        "html_filename": "Time.html",
        "alias": null,
        "protected": false,
      ...
      {
        "type": "Date",
        "doc": "<p>The maximum time to be shown in the list of times. This must be a Date object (only the time fields\nwill be used); no parsing of String values will be done. Defaults to undefined.</p>\n",
        "href": "Time.html#Ext-picker-Time-cfg-maxValue",
        "linenr": 36,
        "html_filename": "Time.html",
        "alias": null,
        "protected": false,
      ...
      {
        "type": "Date",
        "doc": "<p>The minimum time to be shown in the list of times. This must be a Date object (only the time fields\nwill be used); no parsing of String values will be done. Defaults to undefined.</p>\n",
        "href": "Time.html#Ext-picker-Time-cfg-minValue",
        "linenr": 30,
        "html_filename": "Time.html",
        "alias": null,
        "protected": false,
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/view/BoundList.js",
        "private": false,
        "tagname": "cfg",
        "name": "pageSize",
      ...
      {
        "type": "Boolean",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.picker.Time-method-toFront\" rel=\"Ext.picker.Time-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.picker.Time-event-show\" rel=\"Ext.picker.Time-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
    ...
    "method": [
      ...
      {
        "doc": "<p>Set the <a href=\"#/api/Ext.picker.Time-cfg-maxValue\" rel=\"Ext.picker.Time-cfg-maxValue\" class=\"docClass\">maxValue</a> and update the list of available times. This must be a Date\nobject (only the time fields will be used); no parsing of String values will be done.</p>\n",
        "href": "Time.html#Ext-picker-Time-method-setMaxValue",
        "linenr": 102,
        "html_filename": "Time.html",
        "alias": null,
        "return": {
      ...
      {
        "doc": "<p>Set the <a href=\"#/api/Ext.picker.Time-cfg-minValue\" rel=\"Ext.picker.Time-cfg-minValue\" class=\"docClass\">minValue</a> and update the list of available times. This must be a Date\nobject (only the time fields will be used); no parsing of String values will be done.</p>\n",
        "href": "Time.html#Ext-picker-Time-method-setMinValue",
        "linenr": 92,
        "html_filename": "Time.html",
        "alias": null,
        "return": {
      ...
      {
        "doc": "<p>Update the list of available times in the list to be constrained within the\n<a href=\"#/api/Ext.picker.Time-cfg-minValue\" rel=\"Ext.picker.Time-cfg-minValue\" class=\"docClass\">minValue</a> and <a href=\"#/api/Ext.picker.Time-cfg-maxValue\" rel=\"Ext.picker.Time-cfg-maxValue\" class=\"docClass\">maxValue</a>.</p>\n",
        "href": "Time.html#Ext-picker-Time-method-updateList",
        "linenr": 124,
        "html_filename": "Time.html",
        "alias": null,
        "return": {
        ...
        "deprecated": null,
        "shortDoc": "Update the list of available times in the list to be constrained within the\nminValue and maxValue. ...",
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/picker/Time.js",
        "private": false,
        "tagname": "method",
        "name": "updateList",
    ...
    "event": [
      ...
      {
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.picker.Time-event-destroy\" rel=\"Ext.picker.Time-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.picker.Time-event-destroy\" rel=\"Ext.picker.Time-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.picker.Time-event-hide\" rel=\"Ext.picker.Time-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
      ...
      {
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.picker.Time-event-show\" rel=\"Ext.picker.Time-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.picker.Time-event-destroy\" rel=\"Ext.picker.Time-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.picker.Time-event-hide\" rel=\"Ext.picker.Time-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
      ...
      {
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.picker.Time-event-show\" rel=\"Ext.picker.Time-event-show\" class=\"docClass\">show</a> method.</p>\n",
